...
public class PokemonNameToken extends ClipboardToken {
    ...
    public String getLongDescription(Context context) {
        ...
        String returner = String.format(context.getString(R.string.token_name), getCappedLength(pokeName));

        if (maxLength < 12) {
            returner += " " + String.format(context.getString(R.string.token_name_length), num);
        }
        return returner;
    }
