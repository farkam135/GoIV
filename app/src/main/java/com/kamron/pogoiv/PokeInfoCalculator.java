...
public class PokeInfoCalculator {
     ...
     */
    public String getMaxReqText(float trainerLevel, double estimatedPokemonLevel) {
     ...
     */
    public String getCpRangeAtLevel(int pokemonIndex, int lowAttack, int lowDefense, int lowStamina, int highAttack, int highDefense, int highStamina, double level) {
